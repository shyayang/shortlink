    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (Objects.equals(hasShortLinkDO.getGid(), requestParam.getGid())) {
            ...
            try {
                ...
                LambdaUpdateWrapper<LinkLocateStatsDO> linkLocateStatsUpdateWrapper = Wrappers.lambdaUpdate(LinkLocateStatsDO.class)
                ...
                LinkLocateStatsDO linkLocateStatsDO = LinkLocateStatsDO.builder()
                        .gid(requestParam.getGid())
                        .build();
                linkLocateStatsMapper.update(linkLocateStatsDO, linkLocateStatsUpdateWrapper);
