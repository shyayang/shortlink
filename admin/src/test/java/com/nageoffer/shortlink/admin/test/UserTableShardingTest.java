...
public class UserTableShardingTest {
    ...
    public static final String SQL = "CREATE TABLE `t_user_%d` (\n" +
            ...
            "  `del_flag` tinyint(1) DEFAULT NULL COMMENT '删除标识0：未删除1：已删除',\n" +
            "  PRIMARY KEY (`id`),\n" +
            "  UNIQUE KEY `idx_unique_username` (`username`) USING BTREE\n" +
            ") ENGINE=InnoDB AUTO_INCREMENT=1743282890075942915 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;";
